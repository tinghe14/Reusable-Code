...
def test_last_model(last_model_cp, train_sentences, train_tags, test_sentences, test_tags, args):
    model = BioBERTTagger()
...
def test_best_model(best_model_cp, train_sentences, train_tags, test_sentences, test_tags, agrs):
    model = BioBERTTagger()
